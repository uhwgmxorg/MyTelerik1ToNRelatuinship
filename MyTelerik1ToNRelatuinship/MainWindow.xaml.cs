...
namespace MyTelerik1ToNRelatuinship
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PeopleBooksGrid_AddingNewDataItem(object sender, Telerik.Windows.Controls.GridView.GridViewAddingNewEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PeopleBooksGrid_RowEditEnded(object sender, GridViewRowEditEndedEventArgs e)
        {
            _logger.Info("Edit an item");
            try
            {
                PeopleBooksEntityFrameworkDataSource.SubmitChanges();
            }
            catch (Exception ex)
            {
                _logger.Error(ex);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void PeopleBooksGrid_Deleted(object sender, GridViewDeletedEventArgs e)
        {
        ...
        private void LoadData()
        {
            ...
            try
            {
                ...
                PeopleBooksEntityFrameworkDataSource.DbContext = new TestDBEntities();
                PeopleBooksEntityFrameworkDataSource.DbContext.Database.Log = DBLog;
            }
            catch (Exception ex)
            {
                _logger.Error(ex);
